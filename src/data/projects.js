...
export const projects = [
    {
        ...
        title: "TrackWise",
        tags: ["UX/UI", "Case Study", "AI-Assisted", "Figma Make", "Claude"],
        ...
        titleLine1: 'TrackWise',
        subtitle: 'An AI-assisted job tracker that analyzes resume versions and application outcomes to help job seekers refine their strategy.',
        tools: 'Figma, Figma Make, Claude',
        role: 'UX/UI Designer',
        timeline: '2 weeks',
        industry: 'HR Tech, Productivity',
    },
    {
        id: 2,
    ...
    },
    {
        ...
        tags: ["UX/UI", "Case Study", "Redesign"],
